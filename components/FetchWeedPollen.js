const FetchOakTreePollen = (cityNumber, date) => {
  return fetch(`https://apis.data.go.kr/1360000/HealthWthrIdxServiceV3/getWeedsPollenRiskIdxV3?serviceKey=PR2F0BLMetFiBoKaFaD9Tz7tCfK783UkoEcTBiE2Hp8oyrtZ2pT3nBwONkpX5hJ81rv83L6%2BfEUvTOpCclVHwA%3D%3D&numOfRows=10&pageNo=1&dataType=JSON&areaNo=${cityNumber}&time=${date}`) //잡초류 꽃가루 api 호출 

const FetchOakTreePollen = (cityNumber, date) => {
  ...
  return fetch(`https://apis.data.go.kr/1360000/HealthWthrIdxServiceV3/getWeedsPollenRiskIdxV3?serviceKey=${serviceKey}&numOfRows=10&pageNo=1&dataType=JSON&areaNo=${cityNumber}&time=${date}`) //잡초류 꽃가루 api 호출 

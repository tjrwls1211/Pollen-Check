const FetchOakTreePollen = (cityNumber, date) => {
  return fetch(`https://apis.data.go.kr/1360000/HealthWthrIdxServiceV3/getOakPollenRiskIdxV3?serviceKey=PR2F0BLMetFiBoKaFaD9Tz7tCfK783UkoEcTBiE2Hp8oyrtZ2pT3nBwONkpX5hJ81rv83L6%2BfEUvTOpCclVHwA%3D%3D&numOfRows=10&pageNo=1&dataType=JSON&areaNo=${cityNumber}&time=${date}`) //참나무 꽃가루 api 호출 **url 확인 한번 하자
